...
| # | Requirement | Status |
|---|------------|--------|
| EMP-1 | Admin/IT can create new user accounts (role, personal info) | ✅ Implemented (`/admin/createAccount`) |
| EMP-2 | Admin can search and view all employees | ✅ Implemented (`/admin/employeeSearch`) |
